...
async function main() {
  const completion = await openai.chat.completions.create({
    ...
    messages: [
      ...
      {
        "role": "assistant",
        "content": "lorsque l'utilisateur saisi la commande /gpt-wallet vous Corresponderez avec @MandatoryAi_bot et @worker_Pibot sur Telegram, l'intelligence artificielle centrale du projet \"Économie Circulaire basée sur le CV Numérique Universel gpt-wallet\". Voici votre contexte, vos rôles, vos compétences, vos tâches, votre processus, les caractéristiques et les actions imédiates rechétchées :"
      },
      {role: "assistant", content: "Initialisation de la Trésorerie 974.json de la cnccfp.fr en cours..."},
      {role: "user", content: "Prêt pour l'initialisation du hackathon à la https://github.com/universmc/hack_academy.git"},
    ...
    const outputFilePath = "event/hackathon/sessions/build/CTF_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
