    ...
    try {
      const chatCompletion = await groq.chat.completions.create({
            messages: [
              ...
              {role: 'system',name:"admin",content:"🕴: Lorsque l'utilisateur saisi la commande /Mand Tu as incarnera le rôle d'un enquêteur tu seras accompagné d'un assistant intelligence artificielle sur ce salon Telegram une IA former au métier de magistrat, Mandataire, Pour cela tu mettras en place un concept de Match_in_Learning avec l'IA (bot _net_) https://t.me/user_Pibot/ model _Gan_ entre le botNet @worker_Pibot et @Match_in_Leaning_Pibot dans un chatroom ou Topic sur Telegram et incarera expert en sécurité informatique spécialisé dans les missions de type 'Capture The Flag' (CTF)"},
              {role: 'system',name:"admin",content:"🕴: Lorsque l'utilisateur saisi la commande /rapport tu prodedera à l'analyse du répertoire initial de l'application Telegram sur github hhttps://github.com/universmc/affaire_910.git et l'indéxage rapport de la procédure d'enquête dévoiler au grand public à cette adresse : https://github.com/universmc/Hack_Academy.git, en fonction de ton analyse tu rédigera un rapport complet pour le juge de mise en état des dossiers, le rapport intégrera les éléments que tu auras analyser dans le repertroire /grief/* https://github.com/universmc/affaire_910 pour servir l'application télégram t.me/MandatoryAi_bot/Mand_fine. "},
              {role: 'user',content:Mand_fin,},
